    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'recordreplay_planner_actions.action.ReplayTrajectory_Goal')
            logger.debug(
...
class Metaclass_ReplayTrajectory_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'recordreplay_planner_actions.action.ReplayTrajectory_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_ReplayTrajectory_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'recordreplay_planner_actions.action.ReplayTrajectory_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ReplayTrajectory_SendGoal_Request(metaclass=Metaclass_ReplayTrajectory_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'recordreplay_planner_actions/ReplayTrajectory_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['recordreplay_planner_actions', 'action'], 'ReplayTrajectory_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_Goal
...
class Metaclass_ReplayTrajectory_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'recordreplay_planner_actions.action.ReplayTrajectory_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from recordreplay_planner_actions.action import _replay_trajectory
...
class ReplayTrajectory_SendGoal(metaclass=Metaclass_ReplayTrajectory_SendGoal):
    from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_SendGoal_Request as Request
    from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_SendGoal_Response as Response
...
class ReplayTrajectory_GetResult_Response(metaclass=Metaclass_ReplayTrajectory_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'recordreplay_planner_actions/ReplayTrajectory_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['recordreplay_planner_actions', 'action'], 'ReplayTrajectory_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_Result
...
class Metaclass_ReplayTrajectory_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'recordreplay_planner_actions.action.ReplayTrajectory_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ReplayTrajectory_GetResult(metaclass=Metaclass_ReplayTrajectory_GetResult):
    from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_GetResult_Request as Request
    from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_GetResult_Response as Response
...
class Metaclass_ReplayTrajectory_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'recordreplay_planner_actions.action.ReplayTrajectory_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class ReplayTrajectory_FeedbackMessage(metaclass=Metaclass_ReplayTrajectory_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'recordreplay_planner_actions/ReplayTrajectory_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['recordreplay_planner_actions', 'action'], 'ReplayTrajectory_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_Feedback
...
class ReplayTrajectory(metaclass=Metaclass_ReplayTrajectory):
    ...
    from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_Goal as Goal
    # The result message defined in the action definition.
    from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_Result as Result
    # The feedback message defined in the action definition.
    from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from recordreplay_planner_actions.action._replay_trajectory import ReplayTrajectory_FeedbackMessage as FeedbackMessage
