...
class Metaclass_NodeDetails(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosapi.srv import _node_details
...
class NodeDetails(metaclass=Metaclass_NodeDetails):
    from rosapi.srv._node_details import NodeDetails_Request as Request
    from rosapi.srv._node_details import NodeDetails_Response as Response
