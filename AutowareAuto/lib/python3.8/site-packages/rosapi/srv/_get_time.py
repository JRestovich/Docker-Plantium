...
class Metaclass_GetTime(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosapi.srv import _get_time
...
class GetTime(metaclass=Metaclass_GetTime):
    from rosapi.srv._get_time import GetTime_Request as Request
    from rosapi.srv._get_time import GetTime_Response as Response
