...
class ServiceResponseDetails_Response(metaclass=Metaclass_ServiceResponseDetails_Response):
    ...
    _fields_and_field_types = {
        'typedefs': 'sequence<rosapi/TypeDef>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['rosapi', 'msg'], 'TypeDef')),  # noqa: E501
    )
...
class Metaclass_ServiceResponseDetails(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'rosapi.srv.ServiceResponseDetails')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from rosapi.srv import _service_response_details
...
class ServiceResponseDetails(metaclass=Metaclass_ServiceResponseDetails):
    from rosapi.srv._service_response_details import ServiceResponseDetails_Request as Request
    from rosapi.srv._service_response_details import ServiceResponseDetails_Response as Response
