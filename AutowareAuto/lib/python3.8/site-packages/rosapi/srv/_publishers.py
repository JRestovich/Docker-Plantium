...
class Metaclass_Publishers(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosapi.srv import _publishers
...
class Publishers(metaclass=Metaclass_Publishers):
    from rosapi.srv._publishers import Publishers_Request as Request
    from rosapi.srv._publishers import Publishers_Response as Response
