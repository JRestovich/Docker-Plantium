...
class Metaclass_TopicType(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosapi.srv import _topic_type
...
class TopicType(metaclass=Metaclass_TopicType):
    from rosapi.srv._topic_type import TopicType_Request as Request
    from rosapi.srv._topic_type import TopicType_Response as Response
