...
class Metaclass_TopicsForType(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosapi.srv import _topics_for_type
...
class TopicsForType(metaclass=Metaclass_TopicsForType):
    from rosapi.srv._topics_for_type import TopicsForType_Request as Request
    from rosapi.srv._topics_for_type import TopicsForType_Response as Response
