...
class Metaclass_HasParam(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from rosapi.srv import _has_param
...
class HasParam(metaclass=Metaclass_HasParam):
    from rosapi.srv._has_param import HasParam_Request as Request
    from rosapi.srv._has_param import HasParam_Response as Response
