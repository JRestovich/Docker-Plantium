...
#ifndef ROSAPI__MSG__DETAIL__TYPE_DEF__STRUCT_HPP_
#define ROSAPI__MSG__DETAIL__TYPE_DEF__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__rosapi__msg__TypeDef __attribute__((deprecated))
#else
# define DEPRECATED__rosapi__msg__TypeDef __declspec(deprecated)
#endif
...
struct TypeDef_
{
  ...
  // pointer types
  using RawPtr =
    rosapi::msg::TypeDef_<ContainerAllocator> *;
  using ConstRawPtr =
    const rosapi::msg::TypeDef_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<rosapi::msg::TypeDef_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<rosapi::msg::TypeDef_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      rosapi::msg::TypeDef_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<rosapi::msg::TypeDef_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<rosapi::msg::TypeDef_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<rosapi::msg::TypeDef_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<rosapi::msg::TypeDef_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__rosapi__msg__TypeDef
    std::shared_ptr<rosapi::msg::TypeDef_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__rosapi__msg__TypeDef
    std::shared_ptr<rosapi::msg::TypeDef_<ContainerAllocator> const>
...
using TypeDef =
  rosapi::msg::TypeDef_<std::allocator<void>>;
...
#endif  // ROSAPI__MSG__DETAIL__TYPE_DEF__STRUCT_HPP_
