...
{
  new (message_memory) rosapi::msg::TypeDef(_init);
}

void TypeDef_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::msg::TypeDef *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TypeDef_message_member_array[7] = {
  {
    ...
    offsetof(rosapi::msg::TypeDef, type),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::msg::TypeDef, fieldnames),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::msg::TypeDef, fieldtypes),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::msg::TypeDef, fieldarraylen),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::msg::TypeDef, examples),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::msg::TypeDef, constnames),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::msg::TypeDef, constvalues),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TypeDef_message_members = {
  "rosapi::msg",  // message namespace
  "TypeDef",  // message name
  7,  // number of fields
  sizeof(rosapi::msg::TypeDef),
...
get_message_type_support_handle<rosapi::msg::TypeDef>()
{
  return &::rosapi::msg::rosidl_typesupport_introspection_cpp::TypeDef_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, msg, TypeDef)() {
  return &::rosapi::msg::rosidl_typesupport_introspection_cpp::TypeDef_message_type_support_handle;
}
