...
#ifndef ROSAPI__SRV__DETAIL__GET_PARAM__FUNCTIONS_H_
#define ROSAPI__SRV__DETAIL__GET_PARAM__FUNCTIONS_H_
 ...
 * calls
 * rosapi__srv__GetParam_Request__init().
...
/**
 * It calls
 * rosapi__srv__GetParam_Request__fini()
 ...
 * rosapi__srv__GetParam_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * rosapi__srv__GetParam_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * rosapi__srv__GetParam_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi
...
/**
 * It calls
 * rosapi__srv__GetParam_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi
...
/**
 * It allocates the memory for the array and calls
 * rosapi__srv__GetParam_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_rosapi
...
/**
 * It calls
 * rosapi__srv__GetParam_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROSAPI__SRV__DETAIL__GET_PARAM__FUNCTIONS_H_
