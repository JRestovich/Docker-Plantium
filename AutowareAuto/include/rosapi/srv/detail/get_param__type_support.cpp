...
{
  new (message_memory) rosapi::srv::GetParam_Request(_init);
}

void GetParam_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::GetParam_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetParam_Request_message_member_array[2] = {
  {
    ...
    offsetof(rosapi::srv::GetParam_Request, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::srv::GetParam_Request, default_value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetParam_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(rosapi::srv::GetParam_Request),
...
get_message_type_support_handle<rosapi::srv::GetParam_Request>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetParam_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, GetParam_Request)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetParam_Request_message_type_support_handle;
}
...
void GetParam_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rosapi::srv::GetParam_Response(_init);
}

void GetParam_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::GetParam_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetParam_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::srv::GetParam_Response, value),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetParam_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi::srv::GetParam_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<rosapi::srv::GetParam_Response>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetParam_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, GetParam_Response)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetParam_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetParam_service_members = {
  ...
  // see get_service_type_support_handle<rosapi::srv::GetParam>()
...
get_service_type_support_handle<rosapi::srv::GetParam>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetParam_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, GetParam)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rosapi::srv::GetParam>();
}
