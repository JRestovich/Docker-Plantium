...
#include <stddef.h>
#include "rosapi/srv/detail/services__rosidl_typesupport_introspection_c.h"
...
#include "rosapi/srv/detail/services__struct.h"
...
static rosidl_typesupport_introspection_c__MessageMember Services_Request__rosidl_typesupport_introspection_c__Services_Request_message_member_array[1] = {
  {
    ...
    offsetof(rosapi__srv__Services_Request, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Services_Request__rosidl_typesupport_introspection_c__Services_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi__srv__Services_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi, srv, Services_Request)() {
...
static rosidl_typesupport_introspection_c__MessageMember Services_Response__rosidl_typesupport_introspection_c__Services_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi__srv__Services_Response, services),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Services_Response__rosidl_typesupport_introspection_c__Services_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi__srv__Services_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_rosapi
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi, srv, Services_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_service_members = {
  "rosapi__srv",  // service namespace
  "Services",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_Request_message_type_support_handle,
  NULL  // response message
  // rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_Response_message_type_support_handle
};

static rosidl_service_type_support_t rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_service_type_support_handle = {
  0,
  &rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi, srv, Services)() {
  if (!rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_service_type_support_handle.typesupport_identifier) {
    rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi, srv, Services_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rosapi, srv, Services_Response)()->data;
  }

  return &rosapi__srv__detail__services__rosidl_typesupport_introspection_c__Services_service_type_support_handle;
}
