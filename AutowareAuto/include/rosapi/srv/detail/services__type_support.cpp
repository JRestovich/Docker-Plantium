...
{
  new (message_memory) rosapi::srv::Services_Request(_init);
}

void Services_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::Services_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Services_Request_message_member_array[1] = {
  {
    ...
    offsetof(rosapi::srv::Services_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Services_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi::srv::Services_Request),
...
get_message_type_support_handle<rosapi::srv::Services_Request>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::Services_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, Services_Request)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::Services_Request_message_type_support_handle;
}
...
void Services_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rosapi::srv::Services_Response(_init);
}

void Services_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::Services_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Services_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::srv::Services_Response, services),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Services_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi::srv::Services_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<rosapi::srv::Services_Response>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::Services_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, Services_Response)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::Services_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Services_service_members = {
  ...
  // see get_service_type_support_handle<rosapi::srv::Services>()
...
get_service_type_support_handle<rosapi::srv::Services>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::rosapi::srv::rosidl_typesupport_introspection_cpp::Services_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, Services)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rosapi::srv::Services>();
}
