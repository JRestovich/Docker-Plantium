...
{
  new (message_memory) rosapi::srv::GetTime_Request(_init);
}

void GetTime_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::GetTime_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetTime_Request_message_member_array[1] = {
  {
    ...
    offsetof(rosapi::srv::GetTime_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetTime_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi::srv::GetTime_Request),
...
get_message_type_support_handle<rosapi::srv::GetTime_Request>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetTime_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, GetTime_Request)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetTime_Request_message_type_support_handle;
}
...
void GetTime_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rosapi::srv::GetTime_Response(_init);
}

void GetTime_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::GetTime_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember GetTime_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::srv::GetTime_Response, time),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers GetTime_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi::srv::GetTime_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<rosapi::srv::GetTime_Response>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetTime_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, GetTime_Response)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetTime_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers GetTime_service_members = {
  ...
  // see get_service_type_support_handle<rosapi::srv::GetTime>()
...
get_service_type_support_handle<rosapi::srv::GetTime>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::rosapi::srv::rosidl_typesupport_introspection_cpp::GetTime_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, GetTime)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rosapi::srv::GetTime>();
}
