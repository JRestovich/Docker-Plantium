...
{
  new (message_memory) rosapi::srv::HasParam_Request(_init);
}

void HasParam_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::HasParam_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HasParam_Request_message_member_array[1] = {
  {
    ...
    offsetof(rosapi::srv::HasParam_Request, name),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HasParam_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi::srv::HasParam_Request),
...
get_message_type_support_handle<rosapi::srv::HasParam_Request>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::HasParam_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, HasParam_Request)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::HasParam_Request_message_type_support_handle;
}
...
void HasParam_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) rosapi::srv::HasParam_Response(_init);
}

void HasParam_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<rosapi::srv::HasParam_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HasParam_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(rosapi::srv::HasParam_Response, exists),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HasParam_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(rosapi::srv::HasParam_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<rosapi::srv::HasParam_Response>()
{
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::HasParam_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, HasParam_Response)() {
  return &::rosapi::srv::rosidl_typesupport_introspection_cpp::HasParam_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers HasParam_service_members = {
  ...
  // see get_service_type_support_handle<rosapi::srv::HasParam>()
...
get_service_type_support_handle<rosapi::srv::HasParam>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::rosapi::srv::rosidl_typesupport_introspection_cpp::HasParam_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rosapi, srv, HasParam)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<rosapi::srv::HasParam>();
}
